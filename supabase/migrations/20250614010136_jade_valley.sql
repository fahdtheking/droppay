/*
# Complete DropPay Database Schema - Fixed Version

This migration creates the complete database schema for the DropPay platform,
handling existing types gracefully and ensuring all tables are created properly.

## What this migration does:
1. Safely handles existing types
2. Creates all core tables for the platform
3. Sets up proper relationships and constraints
4. Enables Row Level Security
5. Creates essential indexes for performance

## Tables Created:
- Core: users, user_profiles, user_sessions, login_attempts
- Business: suppliers, resellers  
- Products: categories, products, product_variants, product_reviews
- E-commerce: shopping_carts, cart_items, orders, order_items
- Financial: commissions, payouts, wallet_transactions
- Teams: reseller_teams, team_memberships, team_milestones
- Marketing: tracking_links, link_analytics, campaigns, daily_metrics
- Communication: notifications, messages
- System: ai_agents, system_settings
*/
...
DO $$ BEGIN
    DROP TYPE IF EXISTS reseller_type CASCADE;
