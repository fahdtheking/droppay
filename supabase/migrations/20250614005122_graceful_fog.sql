/*
  # Enhanced DropPay Database Schema

  1. New Tables
    - Enhanced users table with all 7 roles
    - user_profiles for extended user information
    - suppliers with marketplace functionality
    - resellers with team and performance tracking
    - categories with commission rates
    - products with full e-commerce features
    - product_variants for product variations
    - orders and order_items for transaction management
    - commissions and payouts for financial tracking
    - reseller_teams and team_memberships for collaboration
    - team_milestones for collective goals
    - tracking_links for reseller attribution
    - link_analytics for click tracking
    - shopping_carts and cart_items for e-commerce
    - campaigns for marketing management
    - notifications for user communication
    - messages for user-to-user messaging
    - product_reviews for feedback
    - ai_agents for AI tool management
    - system_settings for platform configuration
    - daily_metrics for analytics
