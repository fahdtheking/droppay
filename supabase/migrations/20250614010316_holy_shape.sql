/*
  # Complete DropPay Database Schema - Safe Migration
  
  1. Core Tables
    - users (all 7 roles with enhanced security)
    - user_profiles (extended user information)
    - user_sessions (authentication tracking)
    - login_attempts (security monitoring)
  
  2. Business Tables
    - suppliers (marketplace functionality)
    - resellers (team and commission tracking)
  ...
  4. E-commerce
    - shopping_carts (session management)
    - cart_items (cart contents)
    - orders (transaction processing)
    - order_items (line items with commissions)
  
  5. Financial
    - commissions (multiple commission types)
    - payouts (earnings management)
    - wallet_transactions (financial tracking)
  
  6. Team Features
    - reseller_teams (team collaboration)
    - team_memberships (member relationships)
    - team_milestones (shared goals)
  
  7. Marketing
    - tracking_links (attribution tracking)
    - link_analytics (detailed analytics)
    - campaigns (marketing management)
    - daily_metrics (performance reporting)
